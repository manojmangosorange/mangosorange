...
export default function LocationsSection() {
  ...
  return <section ref={ref} className={`py-16 bg-gradient-to-b from-background to-accent/10 transition-all duration-700 ${isVisible ? 'fade-up visible' : 'fade-up'}`}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          return <Card key={location.city} className="group bg-card/70 backdrop-blur-sm border-0 shadow-lg 
