...
import customSoftwareHero from "@/assets/custom-software-hero.webp";
import customSoftwareDev from "@/assets/custom-software-development.webp";
import softwareTeamCollaboration from "@/assets/software-team-collaboration.webp";
...
const CustomSoftware = () => {
  ...
  const coreServices = [
    {
      ...
      description:
        "Comprehensive customer relationship and enterprise resource planning solutions that operate seamlessly across all platforms - mobile, tablet, and desktop with real-time synchronization.",
      features: [
      ...
      highlight:
        "Boost sales performance by 40% with streamlined CRM processes",
    ...
    },
    {
      ...
      description:
        "Strategic marketing plan analysis and learning management systems powered by AI to maximize your marketing ROI and provide predictive business insights.",
      features: [
    ...
    },
    {
      ...
      description:
        "Transform outdated legacy systems into modern, scalable enterprise applications with zero downtime migration and enhanced security frameworks.",
      features: [
  ...
  const workProcess = [
    {
      ...
      description:
        "We begin by understanding your business purpose, primary goals, and target audience to suggest the optimal project plan.",
      icon: Target,
    ...
    },
    {
      ...
      description:
        "Based on gathered insights, we design optimal page layouts, color combinations, and implement required frameworks and CMS.",
      icon: Code,
    ...
    },
    {
      ...
      description:
        "Rigorous testing of all forms and scripts before launch, followed by continuous monitoring and regular updates.",
      icon: Rocket,
  ...
  const keyBenefits = [
    {
      ...
      description:
        "Over 9 years of specialized experience in IT industry serving 200+ clients across diverse sectors including Real Estate, Healthcare, and Finance.",
    ...
    },
    {
      ...
      description:
        "Complete lifecycle solutions with SOC 2 compliance, end-to-end encryption, and enterprise-grade security protocols for data protection.",
    ...
    },
    {
      ...
      description:
        "Each project gets a certified project manager providing comprehensive updates, timeline tracking, and milestone deliverables with 24/7 support.",
    ...
    },
    {
      ...
      description:
        "W3C Standards compliance, Client Hints Technology, and cutting-edge frameworks for dynamic websites and robust web applications.",
  ...
  const industries = [
    {
      name: "Real Estate",
      icon: Building,
      specialty: "Property management and CRM solutions",
      projects: "50+ projects",
    },
    {
      name: "Healthcare",
      icon: Shield,
      specialty: "HIPAA-compliant patient management systems",
      projects: "30+ projects",
    },
    {
      name: "Education",
      icon: Monitor,
      specialty: "Learning management and assessment platforms",
      projects: "40+ projects",
    },
    {
      name: "Finance",
      icon: Database,
      specialty: "Secure financial and trading applications",
      projects: "25+ projects",
    },
    {
      name: "Manufacturing",
      icon: Settings,
      specialty: "IoT-enabled process automation solutions",
      projects: "35+ projects",
    },
    {
      name: "Retail",
      icon: Users,
      specialty: "E-commerce and omnichannel inventory systems",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ref={heroRef}
        className={`page-top-spacing pb-12 px-4 relative overflow-hidden fade-up ${
          heroVisible ? "visible" : ""
        }`}
      >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-800 leading-relaxed">
                MangosOrange delivers enterprise-grade custom software solutions
                with proven expertise across 200+ successful projects. From
                AI-powered business intelligence to legacy system modernization,
                we provide complete lifecycle solutions that transform your
                business operations and drive measurable growth.
              </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Comprehensive software development services designed for your
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              We manage various domains from diverse sectors with dynamic
              websites and web applications using W3C Standards
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-800 mb-8">
                ...
                scalable, secure, and future-ready applications that drive
                business growth.
              </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-800 mb-8">
                We develop dynamic websites and web applications with W3C
                Standards and Client Hints Technology. Each project gets a
                dedicated Project Coordinator providing comprehensive
                information on tasks, timelines, and deliverables.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-800 max-w-4xl mx-auto leading-relaxed">
              We promise to provide incredibly useful online solutions spanning
              the entire development and design process with ongoing support.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Each project gets a dedicated coordinator for comprehensive
                    project updates and timeline management.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    All our solutions follow W3C standards and implement Client
                    Hints Technology for optimal performance.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Annual maintenance and consulting services to ensure your
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-primary to-secondary relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Let's create custom software solutions that perfectly match your
            business requirements. Complete our request form and our consulting
            representative will get in touch shortly.
          </p>
          <Link to="/contact">
