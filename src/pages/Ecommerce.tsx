...
import ecommerceHero from "@/assets/ecommerce-hero.webp";
import ecommercePlatform from "@/assets/ecommerce-platform.webp";
import ecommerceAnalytics from "@/assets/ecommerce-analytics.webp";
...
const Ecommerce = () => {
  ...
  const coreCapabilities = [
    {
      ...
      description:
        "Comprehensive product catalog management with AI-powered categorization, advanced inventory tracking, and automated stock management.",
      features: [
    ...
    },
    {
      ...
      description:
        "Intelligent shopping cart solution with personalized recommendations, seamless checkout process, and advanced recovery systems.",
      features: [
    ...
    },
    {
      ...
      description:
        "Enterprise-grade payment processing with multiple gateways, advanced fraud protection, and PCI DSS compliance.",
      features: [
    ...
    },
    {
      ...
      description:
        "Multi-carrier shipping integration with real-time rates, automated label generation, and comprehensive tracking systems.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete order management system with AI-powered automation, workflow optimization, and customer communication.",
      features: [
    ...
    },
    {
      ...
      description:
        "AI-driven inventory management with predictive analytics, multi-location support, and supplier integration.",
      features: [
  ...
  const businessBenefits = [
    {
      ...
      description:
        "E-commerce provides the most cost-effective way to reach international markets, expand your customer base, and tap into niche markets with 24/7 availability.",
    ...
    },
    {
      ...
      description:
        "Advanced e-commerce platforms with AI-powered analytics can exponentially grow your company's sales and revenue through data-driven optimization.",
    ...
    },
    {
      ...
      description:
        "Our e-commerce solutions provide bank-level security, SSL encryption, and compliance frameworks ensuring a safe and trusted shopping experience.",
  ...
  const workProcess = [
    {
      ...
      description:
        "We understand your business purpose, primary goals, and target audience to suggest the right e-commerce plan for your project.",
      icon: Target,
      details:
        "Comprehensive business analysis and e-commerce strategy development",
    },
    {
      step: "02",
      title: "Design & Development",
      description:
        "Based on gathered information, we design optimal page layouts, color combinations, and implement required frameworks and CMS.",
      icon: Settings,
    ...
    },
    {
      ...
      description:
        "Before launch, we rigorously test all forms and scripts. Post-launch, we provide opinion monitoring and regular updates.",
      icon: Zap,
  ...
  const serviceHighlights = [
    {
      ...
      description:
        "Creating better e-commerce futures through cutting-edge technology, AI integration, and accumulated expertise spanning 500+ successful projects.",
    ...
    },
    {
      ...
      description:
        "We cultivate lasting partnerships with clients through comprehensive support, ongoing optimization, and dedicated account management for mutual growth.",
    ...
    },
    {
      ...
      description:
        "We provide end-to-end e-commerce solutions spanning design, development, marketing integration, analytics, and annual maintenance services.",
    ...
    },
    {
      ...
      description:
        "Our e-commerce platforms are built with W3C standards, mobile-first design, and performance optimization achieving 99.9% uptime reliability.",
  ...
  const industries = [
    {
      ...
      icon: Store,
      focus: "Luxury and fast-fashion online stores",
      growth: "45% growth",
    },
    {
      name: "Electronics & Tech",
      icon: Smartphone,
      focus: "Consumer electronics and gadgets marketplace",
      growth: "60% growth",
    },
    {
      name: "Health & Beauty",
      icon: Shield,
      focus: "Cosmetics, skincare, and wellness products",
      growth: "35% growth",
    },
    {
      name: "Food & Beverage",
      icon: Package,
      focus: "Gourmet foods, beverages, and meal delivery",
      growth: "80% growth",
    },
    {
      name: "Home & Garden",
      icon: Settings,
      focus: "Furniture, decor, and home improvement",
      growth: "40% growth",
    },
    {
      name: "Sports & Fitness",
      icon: Target,
      focus: "Athletic gear, equipment, and supplements",
      growth: "55% growth",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ref={heroRef}
        className={`page-top-spacing pb-12 relative overflow-hidden fade-up ${
          heroVisible ? "visible" : ""
        }`}
      >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-800 leading-relaxed">
                MangosOrange E-Commerce delivers enterprise-grade online retail
                solutions with complete control over every aspect of your
                digital storefront. From AI-powered product recommendations to
                advanced analytics, we provide the tools and capabilities needed
                to dominate your market and achieve exponential growth.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Access real-time information about product categories with our
              sophisticated online stock and inventory management system
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              E-commerce provides the most affordable way to reach new markets
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Our proven methodology ensures successful e-commerce deployment
              from concept to ongoing success
            </p>
          </div>
      ...
      <section
        ref={workflowRef}
        className={`py-20 bg-muted/30 fade-up ${
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              We create and preserve lasting connections with our customers
              through comprehensive e-commerce solutions
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              We manage various domains from different sectors with dynamic
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-800 max-w-4xl mx-auto leading-relaxed">
              Our years of involvement in IT services have given us the ability
              to comprehend and value the needs of businesses today. We develop
              dynamic e-commerce websites with W3C Standards and Client Hints
              Technology, designating a Project Coordinator for comprehensive
              project information.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Each project gets a dedicated coordinator providing
                    comprehensive information on tasks, timelines, and
                    deliverables.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-2">
                    W3C Standards & Technology
                  </h3>
                  <p className="text-gray-800">
                    All our e-commerce solutions follow W3C standards and
                    implement Client Hints Technology for optimal performance.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Annual maintenance and consulting services plus regular
                    updates to ensure your e-commerce platform performs
                    optimally.
                  </p>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-800 mb-8">
                Our e-commerce platform provides complete control over every
                aspect of your online business, from product management to
                customer analytics.
              </p>
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center gap-2 p-3 bg-card rounded-lg hover:shadow-md transition-shadow"
                    >
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-800 mb-8">
                Gain deep insights into your e-commerce performance with
                advanced analytics, customer behavior tracking, and predictive
                ...
                {[
                  {
                    ...
                    desc: "Track sales performance and trends in real-time",
                  },
                  {
                    title: "Customer Behavior Analysis",
                    desc: "Understand customer journey and optimize conversions",
                  },
                  {
                    title: "Inventory Optimization",
                    desc: "AI-powered inventory forecasting and management",
                  },
                  {
                    title: "Performance Monitoring",
                    desc: "Monitor site performance and user experience metrics",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-secondary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Let's create an e-commerce platform that provides complete control
            over your business processes. Complete our request form and our
            consulting representative will get in touch shortly.
          </p>
          <Link to="/contact">
