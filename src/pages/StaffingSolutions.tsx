...
const processSteps = [
  {
    ...
    description:
      "We analyze your requirements, culture, and specific skill needs",
  },
  {
    icon: Users,
    title: "Source & Screen Talent",
    description:
      "Our experts identify and evaluate candidates from our extensive network",
  },
  {
    icon: FileText,
    title: "Share Curated Profiles",
    description:
      "Receive carefully selected profiles that match your exact criteria",
  },
  {
    icon: UserPlus,
  ...
  },
  {
    ...
    description:
      "Ongoing support and performance monitoring for optimal results",
  },
];
const benefits = [
  {
    ...
    description:
      "Scale your workforce up or down based on project demands and business needs",
  },
  {
    icon: Clock,
    title: "Faster Turnaround",
    description:
      "Quick deployment of pre-vetted professionals to meet urgent requirements",
  },
  {
    icon: Award,
    title: "Reduced HR Load",
    description:
      "We handle recruitment, compliance, and administrative tasks for you",
  },
  {
    icon: Target,
    title: "Quality Assurance",
    description:
      "Rigorous screening process ensures only top-tier candidates reach you",
  },
];
const whyChooseUs = [
  {
    ...
    description:
      "Nationwide coverage to serve your business across all locations",
  },
  {
    icon: Clock,
    title: "Quick Talent Deployment",
    description:
      "Rapid placement with our extensive talent pool and streamlined processes",
  },
  {
    icon: Award,
    title: "Performance Monitoring Support",
    description:
      "Continuous support and performance tracking for lasting success",
  },
  {
    icon: Users,
    title: "Expertise Across Domains",
    description:
      "Deep industry knowledge and specialized recruitment expertise",
  },
  {
    icon: CheckCircle,
...
const StaffingSolutions = () => {
  ...
  const { ref: industriesRef, isVisible: industriesVisible } =
    useScrollAnimation();
  ...
  const jsonLd = {
    ...
    description:
      "Tailored hiring across roles and industries with contract and permanent placements, fast turnaround, and pan-India coverage.",
    areaServed: "IN",
      ...
      <main role="main">
        ...
        <section className="relative page-top-spacing pb-20 px-4 overflow-hidden">
          ...
          <div className="container mx-auto max-w-6xl relative">
            <div
              ref={heroRef}
              className={`text-center space-y-8 max-w-4xl mx-auto fade-up ${
                heroVisible ? "visible" : ""
              }`}
            >
              ...
              <p className="text-xl md:text-2xl text-gray-800 leading-relaxed max-w-2xl mx-auto">
                Empowering your workforce with top-tier talent – on time, every
                time.
              </p>
        ...
        <section className="py-20 bg-gradient-to-r from-primary/5 to-secondary/5">
          <div className="container mx-auto px-4">
            <div
              ref={overviewRef}
              className={`grid lg:grid-cols-2 gap-16 items-center fade-up ${
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 text-lg text-gray-800">
                    <p>
                      We provide qualified and experienced professionals capable
                      of driving your business growth. From contractual
                      placements to permanent hires, we handle all your staffing
                      needs.
                    </p>
                    <p>
                      Our domain-specific recruiters bring profound market
                      insights and tailor-made solutions to match your exact
                      requirements, whether you need entry-level talent or
                      senior leadership.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div
              ref={processRef}
              className={`grid md:grid-cols-2 lg:grid-cols-5 gap-8 fade-up ${
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-800 max-w-2xl mx-auto">
                Specialized staffing solutions across diverse sectors and
                industries
              </p>
            </div>
            ...
            <div
              ref={industriesRef}
              className={`grid md:grid-cols-2 lg:grid-cols-4 gap-6 fade-up ${
                industriesVisible ? "visible" : ""
              }`}
            >
        ...
        <section className="py-20 bg-gradient-to-r from-primary/5 to-secondary/5">
          <div className="container mx-auto px-4">
            ...
            <div
              ref={whyUsRef}
              className={`grid md:grid-cols-2 lg:grid-cols-5 gap-6 fade-up ${
              ...
              <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-3xl p-8 md:p-12 border border-primary/20 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <blockquote className="text-xl md:text-2xl font-medium text-foreground mb-6 leading-relaxed">
                    "Their expertise in finding the right talent for our
                    specialized roles has been exceptional. The team understands
                    our industry requirements and consistently delivers quality
                    candidates."
                  </blockquote>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto space-y-8">
              ...
              <p className="text-xl text-gray-800">
                Let's discuss your staffing needs and find the perfect
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/contact">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-primary to-primary-glow text-primary-foreground hover:scale-105 transition-transform duration-300 group"
                  >
                    Contact Now
