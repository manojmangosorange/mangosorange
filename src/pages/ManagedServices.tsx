...
import managedServicesHero from "@/assets/managed-services-hero.webp";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="group bg-card rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 animate-fade-in hover-scale">
              ...
              <p className="text-gray-800">
                Round-the-clock monitoring of your cloud infrastructure with
            ...
            >
              ...
              <p className="text-gray-800">
                Continuous cost analysis and optimization to ensure you get
            ...
            >
              ...
              <p className="text-gray-800">
                Comprehensive security monitoring and compliance management to
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start space-x-4 animate-fade-in">
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Focus on your core business while we handle your cloud
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Optimize costs through continuous monitoring and resource
                    management.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Scale your infrastructure management as your business grows.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    Access to certified cloud professionals and specialists.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4 bg-primary/5">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-800 mb-8 max-w-2xl mx-auto">
            Focus on growing your business while we take care of your cloud
            infrastructure with our comprehensive managed services.
          </p>
          <Link to="/contact">
