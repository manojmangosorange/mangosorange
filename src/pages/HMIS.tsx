...
import hmisHeroImage from "@/assets/hmis-hero.webp";
...
const HMIS = () => {
  ...
  const features = [
    {
      ...
      description:
        "Complete electronic medical records with patient registration, history tracking, and digital documentation.",
    },
    {
      icon: CreditCard,
      title: "Billing & Insurance Integration",
      description:
        "Automated billing systems with insurance claim processing and payment gateway integration.",
    },
    {
      icon: Calendar,
      title: "Appointment Scheduling",
      description:
        "Smart scheduling system with automated reminders and doctor availability management.",
    },
    {
      icon: Package,
      title: "Pharmacy & Inventory Management",
      description:
        "Real-time inventory tracking, automated reordering, and pharmacy integration.",
    },
    {
      icon: FlaskConical,
      title: "Lab Reports & Diagnostics",
      description:
        "Digital lab management with result tracking, report generation, and diagnostic workflows.",
    },
    {
      icon: BarChart3,
      title: "Real-Time Dashboards & Analytics",
      description:
        "Comprehensive analytics with KPI tracking, performance metrics, and business intelligence.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "The HMIS platform transformed our operations completely. Patient wait times decreased by 40% and our staff productivity increased significantly.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "Implementation was seamless and the support team was exceptional. The analytics dashboard gives us insights we never had before.",
      rating: 5,
    },
    {
      ...
      content:
        "The EMR system is intuitive and saves us hours daily. The integration with lab systems is flawless.",
      rating: 5,
    },
  ];
  ...
  const techStack = [
    { name: "React & TypeScript", description: "Modern frontend development" },
    {
      ...
      description: "Scalable and secure hosting",
    },
    {
        ...
        >
          <div className="max-w-4xl">
            ...
            <p className="text-xl lg:text-2xl text-foreground mb-8 max-w-3xl leading-relaxed">
              Our HMIS platform streamlines patient care, billing, inventory,
              and records in one centralized dashboard.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Streamline every aspect of your healthcare operations with our
              integrated platform
            </p>
          </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/20 to-transparent rounded-2xl flex items-end p-8">
                <div className="text-left">
                  ...
                  <p className="text-gray-800">
                    See how easy it is to manage your hospital operations
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 lg:px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Join hundreds of healthcare providers already transforming their
              operations
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-accent/20 to-background">
        <div className="container mx-auto px-4 lg:px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              See what healthcare professionals are saying about our HMIS
              platform
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-secondary/5 to-primary/5">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-800 mb-12">
              Our HMIS platform leverages cutting-edge technology for
        ...
        <div className="container mx-auto px-4 lg:px-6">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/90 mb-12 max-w-3xl mx-auto">
              Join leading healthcare providers who trust MangosOrange HMIS for
